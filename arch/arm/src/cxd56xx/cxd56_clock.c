...
static mutex_t g_clockexc = NXMUTEX_INITIALIZER;
...
static void clock_lock(mutex_t *id)
{
...
static void clock_unlock(mutex_t *id)
{
  if (!up_interrupt_context())
    {
      nxmutex_unlock(id);
