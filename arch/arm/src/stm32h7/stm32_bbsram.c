...
{
  mutex_t  excllock;           /* For atomic accesses to this structure */
      ...
      if (alloc <= avail)
        {
          ...
          nxmutex_init(&g_bbsram[i].excllock);
        }
