...
static mutex_t g_rotexc;
static mutex_t g_geexc;
static mutex_t g_abexc;
...
{
  nxmutex_init(&g_rotexc);
  nxsem_init(&g_rotwait, 0, 0);
  nxmutex_init(&g_geexc);
  nxmutex_init(&g_abexc);
...
void imageproc_finalize(void)
{
  ...
  nxmutex_destroy(&g_rotexc);
  nxmutex_destroy(&g_geexc);
  nxmutex_destroy(&g_abexc);
}
