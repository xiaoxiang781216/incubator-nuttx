...
case ${os} in
  Darwin)
    ...
    ;;
  Linux)
    install="arm-clang-toolchain arm-gcc-toolchain arm64-gcc-toolchain bloaty ccache clang_clang-tidy gen-romfs gperf kconfig-frontends mips-gcc-toolchain python-tools riscv-gcc-toolchain rust rx-gcc-toolchain sparc-gcc-toolchain xtensa-esp32-gcc-toolchain"
    ;;
esac
